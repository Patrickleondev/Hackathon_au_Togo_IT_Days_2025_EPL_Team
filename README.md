...
| [04-INSTALL.md](docs/04-INSTALL.md) | Local development install, prerequisites, first run |
...
| [08-DEPLOYMENT.md](docs/08-DEPLOYMENT.md) | Production Docker, TLS, secrets, hardening, scaling |
